  ...
  <div class="row">
    ...
    <?php foreach ($employeelist as $e){ ?>
      <tr>
        ...
        <td><?php if (isset($e->EmployeeID)) echo '<a href="'.URL_BASE.'/employee/viewmanager/'.$e->EmployeeID.'" data-toggle="tooltip" title="Voir" class="btn btn-success btn-sm"><i class="fas fa-eye"></i></a>';?></td>
