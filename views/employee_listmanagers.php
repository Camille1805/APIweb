<main role="main" class="container">
    <div class="starter-template">
      <h1>Affichage de la liste des managers</h1>
    </div>
  ...
  <div class="row">
    ...
    <?php foreach ($employeelist as $e){ ?>
      <tr>
        ...
        <td><?php if (isset($e->EmployeeID)) echo '<a href="index.php?c=employee&m=viewmanager&id='.$e->EmployeeID.'" data-toggle="tooltip" title="Voir" class="btn btn-success btn-sm"><i class="fas fa-eye"></i></a>';?></td>
